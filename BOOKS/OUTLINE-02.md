...
| — | Melee weapons | **`DRAFTED` — REVISION IN PROGRESS** | `ITEMS-01` (`melee-one-handed` 78, `melee-two-handed` 42, both games). Full-catalogue standard applied incrementally — Vibrosword family complete as a format check; ten more K1 families plus K2-exclusive families pending. **⚠ Structural question open: some K2 melee items don't match Chapter One's eleven base weapon types.** **Text at `BOOKS/armory/02-melee-weapons.md`** |
