...
241 items, none appearing in both games — every entry here is specific to one game or
...
|---|---|---|---|---|
| **Safety Harness** | Belt | K2 | 100 | Skill bonus (unmapped subtype — see below) |
...
| **Sparring Gloves** | Gauntlets | ⚠ authored | 90 | `Damage (Bludgeoning) 1` — an unarmed-adjacent item for a slot that otherwise mostly carries skill bonuses |
