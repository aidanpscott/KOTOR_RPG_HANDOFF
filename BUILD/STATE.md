...
|---|---|---|
| `KOTOR_RPG_MAIN_WORK` | `111ac16` — turn order, and striking reveals you |      ✓ |
...
| `KOTOR-RPG-APP` | `ee501ed` — `PT-1422` — turn order on screen |      ⚠ no |
...
**`Lodestar` 545 · `Lens` 10 · `Loom` 253 · `KOTOR-RPG-APP` 436 — 1,244, all
green.** *(`BUILD 125`.)*
