...
**Available to organics and to all four playable droid chassis.**

> **⚠⚠ CORRECTED AT `PT-769`. ⚠ THIS LINE READ *"Astromechs and Remotes MAY NOT TAKE RANGED ATTACKS."* ⚠ THAT OVERSTATED THE RESTRICTION TO THE WHOLE FILE.**

**⚠ EXACTLY THREE CHAINS BAR THEM — ⚠ `Rapid Fire`, `Precise Shot` AND `Charged Shot`, EACH SAYING SO IN ITS OWN ROW. ⚠ THE OTHER EIGHT ARE OPEN.**

**⚠ AND `PT-333`'s CREDIT TABLE ALREADY SAID SO: ⚠ *"Astromech · Remote — 2 credits · 1 by class, 1 chosen · ⚠ RANGED ONLY."* ⚠ A CHASSIS WITH RANGED-ONLY CREDITS AND NO RANGED CHAINS WOULD HAVE NOTHING TO SPEND THEM ON.**
...
| › Lethal Shot |  | **Level 4.** **`2d6` damage and +3 attack in position, −2 out of it.** **⚠ On a hit, the target's DEATH THRESHOLD narrows by 2 for the rest of the encounter** — it dies at `−(Con − 2)`. `PT-559`. |
| ›› Execute | The shot taken when the fight is already decided. | **Level 8.** **`3d6` damage and +4 attack in position, −2 out of it.** **⚠ The narrowing rises to 4** — it dies at `−(Con − 4)`, and ⚠ **a target already at 0 or below is killed outright if this hit would reach its threshold.** `PT-559`. |
