# CLASS-ROSTER-01 — the four lists
...
| **Soldier** | Built |
| **Scout** | Built |
| **Smuggler** | Built. **`PT-73` — absorbed the Scoundrel** |
| **Bounty Hunter** | Built. **`PT-68`** |
...
**`Explorer` closes the largest structural hole in the skill table.**
    ...
    Science        was Jedi Consular and Tech Specialist
...
**⚠ And `PT-69`'s chain counts are unassigned for every class in the game, old and new.**

**⚠ Prestige entry requirements do not exist for any of the 19 prestige classes.** **`MULTICLASS-01 §6` records this as open.**

---

## 7. Open

**Whether 37 is too many for a core book.** **⚠ Twelve base classes is more than most systems ship. The prestige count is less alarming — those are supplements elsewhere.**

**Whether `Sharpshooter` and `Gunslinger` are distinct enough to both exist.** **Both are ranged prestige.**
